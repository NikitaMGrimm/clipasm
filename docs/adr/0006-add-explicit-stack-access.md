...
the nearest owned body boundary. Values captured this way become owned by the
...
visible values. An owned descendant creates a new boundary that transparent
