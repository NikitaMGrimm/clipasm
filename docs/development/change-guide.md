...
| Change checked-source construction | `src/compiler/check.rs` | linked-program validation, output inference, evaluator metadata, every frontend through canonical source |
