...
use super::draft::{BodyId, DraftBody, DraftInput, DraftInvocation, DraftItemKind};

mod materialize;

use materialize::{BodyBinding, CheckedMaterializer};
...
fn external_definition(
    ...
    Ok(ProgramDefinition {
        ...
        implementation: ProgramImplementation::External(crate::program::ExternalRuntime::new(
...
impl super::typecheck::ResolvedDraftProgram {
    fn into_checked(
        ...
        let mut materializer = CheckedMaterializer::new(
            local_types,
            &bindings.local_ids,
            &alias_checker,
            definitions,
